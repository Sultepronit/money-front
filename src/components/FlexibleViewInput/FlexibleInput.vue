    ...
    <section class="edited">
        ...
        <section class="main-fields">
            <AccountsGroup
                ...
                :additional="[{ name: 'total', account: edited.stefko.credit.sum }]"
            />
            ...
            <AccountsGroup
                ...
                :balances="[
                    ...
                    { name: 'bvr', account: edited.stefko.debitAccounts.account5 },
            ...
            <AccountsGroup
                :date="edited.date"
                :balances="[{ name: 'cash', account: edited.common.cash }]"
                :additional="[
        ...
        <section class="buttons">
            <button class="wait-button" @click="editWait = !editWait">edit wait future</button>
            <button class="wait-button" @click="editCurrency = !editCurrency">edit currency</button>
        </section>
        ...
        <section class="currency" v-if="editCurrency">
            ...
            <AccountsGroup
                :date="edited.date"
                :balances="[{ name: '€', account: edited.stefko.currency.eur.balance }]"
                :parts="[{ name: '⇄', account: edited.stefko.currency.eur.exchanges }]"
                :additional="[
                    { name: '₴', account: edited.stefko.currency.eur.uah },
            ...
            <AccountsGroup
                :date="edited.date"
                :balances="[{ name: '$', account: edited.common.usd.balance }]"
                :parts="[{ name: '⇄', account: edited.common.usd.exchanges }]"
                :additional="[
                    { name: '₴', account: edited.common.usd.uah },
